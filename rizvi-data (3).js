...
// Departments (from Guide_Rizvi.txt) — 10 departments
window.RIZVI_DEPARTMENTS = [
  {id:'PROD',name:'Production',bn:'উৎপাদন',personnel:4987,color:'#f5b800'},
  {id:'QC',name:'Quality Control',bn:'মান নিয়ন্ত্রণ',personnel:698,color:'#10b981'},
  {id:'HR',name:'Administration, HR & Compliance',bn:'এইচআর ও প্রশাসন',personnel:228,color:'#2563eb'},
  {id:'MKT',name:'Marketing & Merchandising',bn:'মার্কেটিং ও মার্চেন্ডাইজিং',personnel:172,color:'#9333ea'},
  {id:'STO',name:'Store/Warehouse',bn:'স্টোর/গুদাম',personnel:168,color:'#0891b2'},
  {id:'FIN',name:'Accounts & Finance',bn:'হিসাব ও অর্থ',personnel:24,color:'#16a34a'},
  {id:'IE',name:'Industrial Engineering (IE)',bn:'শিল্প প্রকৌশল',personnel:24,color:'#ca8a04'},
...
window.RIZVI_DEFAULT_USERS = [
  {id:'ADMIN',email:'ssheraji@gmail.com',password:'Admin123456',role:'admin',name:'Admin',designation:'System Administrator',department:'Administration, HR & Compliance'},
  {id:'EMP-AF1-0001',email:'rabeul.hasan@rizvifashions.com',mobile:'01912708566',password:'12345678',role:'user',name:'Rabeul Hasan',designation:'A.G.M',department:'Accounts & Finance',office_id:'AF1 0001'}
];
...
// ------------------- SEED (in-memory) ------------------- //
window.RIZVI_SEED = {
  rizvi_employees: _seedEmpList(120), // virtualized; user can bulk import full 6423
  rizvi_task_lists:[],
  rizvi_training:[],
  rizvi_salary:[],
  rizvi_payroll:[],
